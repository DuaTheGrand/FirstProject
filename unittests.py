...
class Test_find_time_and_location_return_location_of_class(unittest.TestCase):
    ...
    def test_take_correct_text_return_correct_way(self):
        result = find_time_and_location.return_location_of_class(
            123456789, 'где 222')
...
class Test_find_time_and_location_return_text_about_time_before_lesson_with_location(unittest.TestCase):
    ...
    def test_group_is_not_exist_return_error_message(self):
        date = datetime.datetime.now()
        result = find_time_and_location.return_text_about_time_before_lesson_with_location(
            222222222, 1, date)
        self.assertEqual(
    ...
    def test_when_before_lessons_return_correct_data(self):
        date = datetime.datetime.now()
        result = find_time_and_location.return_text_about_time_before_lesson_with_location(
            111111111, 0, date)
    ...
    @freeze_time('2019-01-09 06:00:00')
    @patch('find_class_location.find_class_location', return_value='путь')
    def test_when_before_lessons_return_correct_data_new_db_column_names(self):
        date = datetime.datetime.now()
        result = find_time_and_location.return_text_about_time_before_lesson_with_location(
            333333333, 0, date)
        self.assertEqual(result, 'Через 3:45 начнётся\nпредмет1\n\nпуть')
...
class Test_main(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        db_funcs_for_students_db.starting_insert_data(
            222222222, 'Ganzeroar2', None, 1576085837)
        db_funcs_for_students_db.update_group(111111111, 417)
        db_funcs_for_students_db.set_is_subscribe_to_newsletter(
            111111111, True)
        db_funcs_for_students_db.set_is_subscribe_to_newsletter(
            222222222, True)
...
class Test_site_parser_undergraduate(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        db_funcs_for_site_parser.change_link_in_current_links(
            'lovs_3_kurs', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//3_kurs_lovs_6_semestr_na_sayt_.xlsx')
        db_funcs_for_site_parser.change_link_in_current_links(
    ...
    def test_get_file_link_from_site_full_time_undergraduate_return_file_link(self):
        obj = site_parser.Site_parser_undergraduate()
        soup_obj = obj.get_soup_obj(texts_for_tests.html_text)
    ...
    def test_format_name_return_correct(self):
        obj = site_parser.Site_parser_undergraduate()
...
class Test_site_parser_undergraduate_imist(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        db_funcs_for_site_parser.insert_link_to_current_links()
        db_funcs_for_site_parser.change_link_in_current_links(
            'imst_1_kurs', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_1_kurs_imst_17.02.xlsx')
        db_funcs_for_site_parser.change_link_in_current_links(
            'imst_2_kurs', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_2_kurs_imst_05.12.xlsx')
        db_funcs_for_site_parser.change_link_in_current_links(
            'imst_3_kurs', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_3_kurs_imst_13.02.xlsx')
        db_funcs_for_site_parser.change_link_in_current_links(
            'imst_4_kurs', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_4_kurs_imst_05.12.xlsx')
    ...
    def test_is_changed_return_true(self):
        ...
        result = obj.is_changed(
            'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_2_kurs_imst_13.02.xlsx')
        self.assertEqual(result, True)
    ...
    def test_find_changed_files_return_2_changed_file_link(self):
        ...
        result = obj.find_changed_files(soup_obj)
        self.assertEqual(len(result), 2)
        self.assertEqual(result, ['http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_2_kurs_imst_13.02.xlsx',
                                  'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_4_kurs_imst_14.02.xlsx'])

    def test_return_file_link_from_site_imst_return_file_link(self):
        obj = site_parser.Site_parser_undergraduate_imst()
        soup_obj = obj.get_soup_obj(texts_for_tests.html_text)
        result = obj.return_file_links_from_site_imst(soup_obj)
        self.assertEqual(result, ('http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_1_kurs_imst_17.02.xlsx', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_2_kurs_imst_13.02.xlsx',
                                  'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_3_kurs_imst_13.02.xlsx', 'http://www.lesgaft.spb.ru/sites/default/files//shedul//raspisanie_4_kurs_imst_14.02.xlsx'))
#
    # def test_find_file_link_return_correct_link(self):
    #    obj = site_parser.Site_parser_undergraduate()
    #    soup_obj = obj.get_soup_obj(texts_for_tests.html_text)
...
#
    # def test_format_name_return_correct(self):
    #    obj = site_parser.Site_parser_undergraduate()
    #    result = obj.format_name('3_kurs_zovs')
    #    self.assertEqual(result, 'zovs_3_kurs')
...
class Test_excel_parser_undergraduate(unittest.TestCase):
    ...
    def test_is_reason_for_skip_return_true(self):
        configurations.month_to_skip = ['01', '02', '03', '10']
        work_sheet_names = ['<Worksheet "с 05.01>"',
                            ...
                            '<Worksheet "шапка">',
                            '<Worksheet "ЛЫЖИ">',
                            '<Worksheet "с 21.09. - 24.10. практика">']
    ...
    def test_undergraduate_parser(self):
        ...
        for couple in groups_and_expected_number_of_records:
            parser.parse_work_file_using_name(
                couple, 'test_time_tables/full_time_undergraduate')
            ...
            print(couple)
            self.assertEqual(expected_number_of_record,
                             actual_number_of_record)
    ...
    def test_imst_parser(self):
        ...
        for couple in groups_and_expected_number_of_records:
            parser.parse_work_file_using_name(
                couple, 'test_time_tables/full_time_undergraduate/imst')
            req = f"SELECT COUNT(*) FROM {couple}"
            self.cursor.execute(req)
            expected_number_of_record = self.cursor.fetchall()[0][0]
            actual_number_of_record = groups_and_expected_number_of_records[couple]
    ...
    def test_mag_fk(self):
        ...
        for couple in groups_and_expected_number_of_records:
            parser.parse_work_file_using_name(
                couple, 'test_time_tables/full_time_magistracy_fk')
            req = f"SELECT COUNT(*) FROM {couple}"
            self.cursor.execute(req)
            expected_number_of_record = self.cursor.fetchall()[0][0]
            actual_number_of_record = groups_and_expected_number_of_records[couple]
    ...
    def test_mag_afk(self):
        ...
        for couple in groups_and_expected_number_of_records:
            parser.parse_work_file_using_name(
                couple, 'test_time_tables/full_time_magistracy_afk')
            req = f"SELECT COUNT(*) FROM {couple}"
            self.cursor.execute(req)
            expected_number_of_record = self.cursor.fetchall()[0][0]
            actual_number_of_record = groups_and_expected_number_of_records[couple]
    ...
    def test_mag_imst(self):
        ...
        for couple in groups_and_expected_number_of_records:
            parser.parse_work_file_using_name(
                couple, 'test_time_tables/full_time_magistracy_imst')
            req = f"SELECT COUNT(*) FROM {couple}"
            self.cursor.execute(req)
            expected_number_of_record = self.cursor.fetchall()[0][0]
            actual_number_of_record = groups_and_expected_number_of_records[couple]
...
class Test_request_handler(unittest.TestCase):
    ...
    def test_main_request_handler_take_settings_and_user_not_in_news_subscribers_return_settings(self):
    ...
    def test_main_request_handler_take_subscriptions_and_newsletter_return_text(self):
        result = request_handler.main_request_handler(
            'Подписки и рассылки', 111111111)
        self.assertEqual(
            result[0], texts_for_lesgaft_bot.go_to_subscriptions_and_newsletters_text)
        self.assertEqual(result[1].keyboard, [[{'text': 'Подписаться на рассылку новостей'}], [
                         {'text': 'Информация о подписках'}], [{'text': 'Вернуться в настройки'}]])

    def test_main_request_handler_take_info_about_subscriptions_user_not_subscribe_return_correct_text(self):
        result = request_handler.main_request_handler(
            'Информация о подписках', 111111111)
        self.assertEqual(
            result[0], texts_for_lesgaft_bot.info_about_subscriptions_text)
        self.assertEqual(result[1].keyboard, [[{'text': 'Подписаться на рассылку новостей'}], [
                         {'text': 'Информация о подписках'}], [{'text': 'Вернуться в настройки'}]])

    def test_main_request_handler_take_subscribe_to_newsletter_then_in_bd_user_subscription_is_true(self):
        result = request_handler.main_request_handler(
            'Подписаться на рассылку новостей', 111111111)
        status = db_funcs_for_students_db.get_subscribe_in_newsletter_status(
            111111111)
        self.assertEqual(result[0], 'Подписка активирована')
        self.assertEqual(result[1].keyboard, [[{'text': 'Отписаться от рассылки новостей'}], [
                         {'text': 'Информация о подписках'}], [{'text': 'Вернуться в настройки'}]])
        self.assertEqual(status, True)

    def test_main_request_handler_take_settings_and_user_already_in_news_subscribers_return_correct_settings(self):
    ...
    def test_main_request_handler_take_info_about_subscriptions_user_subscribe_return_correct_text(self):
        result = request_handler.main_request_handler(
            'Информация о подписках', 222222222)
        self.assertEqual(
            result[0], texts_for_lesgaft_bot.info_about_subscriptions_text)
        self.assertEqual(result[1].keyboard, [[{'text': 'Отписаться от рассылки новостей'}], [
                         {'text': 'Информация о подписках'}], [{'text': 'Вернуться в настройки'}]])

    def test_main_request_handler_take_unsubscribe_to_newsletter_then_in_bd_user_subscription_is_false(self):
        result = request_handler.main_request_handler(
            'Отписаться от рассылки новостей', 222222222)
        db_funcs_for_students_db.set_is_subscribe_to_newsletter(
            222222222, False)
        status = db_funcs_for_students_db.get_subscribe_in_newsletter_status(
            222222222)
    ...
    def test_main_request_handler_take_wrong_timetables_return_correct_text_and_save_in_logfile_new_group(self):
        result = request_handler.main_request_handler(
            'Расписание неправильное', 333333333)
        self.assertEqual(result[0], texts_for_lesgaft_bot.wrong_timetables)
        self.assertEqual(result[1].keyboard, [[{'text': 'Где пара?'}], [{'text': 'Какие сегодня пары?'}], [
                         {'text': 'Какие завтра пары?'}], [{'text': 'Вернуться в меню'}]])
        with open('wrong_timetables_reports.log') as f:
